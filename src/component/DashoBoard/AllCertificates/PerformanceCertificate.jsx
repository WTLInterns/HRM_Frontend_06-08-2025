...
const PerformanceCertificate = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      pdf.save('Performance_Certificate.pdf');
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const apiUrl = `https://api.managifyhr.com/api/certificate/send/${subadmin.id}/${selectedEmployee.empId}/performance`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className={`p-6 rounded-lg shadow-lg ${isDarkMode ? 'bg-slate-700' : 'bg-white'}`}>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-1">Performance Period</label>
                <input 
                  type="text" 
              ...
              <div className="mb-4">
                ...
                <textarea 
                  ...
                  onChange={handleInputChange}
                  className={`w-full p-2 border rounded ${isDarkMode ? 'bg-slate-600 border-slate-500' : 'bg-white border-gray-300'}`}
                  placeholder="Key achievements, strengths, and contributions during this period"
                  rows="2"
                ></textarea>
              </div>
              <div className="mb-4">
              ...
              <div style={{ overflowX: 'auto', maxWidth: '100vw', WebkitOverflowScrolling: 'touch' }}>
                <div 
                  ...
                  style={{ 
                    ...
                    background: 'linear-gradient(135deg, #fff5fa 0%, #fde8f3 40%, #fbcfe8 100%)', // faint pink
                    overflow: 'hidden'
                  }}
                >
                  {/* Decorative Elements */}
                  ...
                  <div className="relative z-10 mt-6">
                    ...
                    <div className="text-center mb-8">
                      <div className="inline-block border-b-2 border-t-2 border-blue-800 px-6 py-2">
                        <h2 className="text-3xl font-bold uppercase tracking-wider text-blue-800">Performance Certificate</h2>
                      </div>
                    </div>
                    ...
                    <div className="mb-8 px-8 text-center">
                      ...
                      <p className="mb-6 text-lg font-serif leading-relaxed">
                        has demonstrated outstanding performance during the period <span className="font-bold">{formData.performancePeriod || "[Performance Period]"}</span> at <span className="font-bold">{subadmin?.registercompanyname || "[Company Name]"}</span>.
                      </p>
                      <div
                        style={{
                          background: '#f0f4fa',
                      ...
                      >
                        ...
                        <p style={{ fontStyle: 'italic', fontSize: '1.1rem', textAlign: 'center', margin: 0 }}>
                          {formData.performanceHighlights || "Consistently exceeded expectations, contributed to team goals, and demonstrated professional growth."}
                        </p>
                      </div>
                      <p className="mb-2 text-lg font-serif">
                        We appreciate your valuable contributions to the organization and wish you continued success.
                      </p>
                    </div>
                    {/* Date and Signature */}
