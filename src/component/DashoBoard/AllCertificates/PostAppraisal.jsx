...
const PostAppraisal = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      pdf.save('Post_Appraisal_Certificate.pdf');
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const apiUrl = `http://localhost:8282/api/certificate/send/${subadmin.id}/${selectedEmployee.empId}/postappraisal`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className={`p-6 rounded-lg shadow-lg ${isDarkMode ? 'bg-slate-700' : 'bg-white'}`}>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-1">Appraisal Score</label>
                <input 
                  type="text" 
                  name="appraisalScore"
              ...
              <div className="mb-4">
                ...
                <textarea 
                  ...
                  onChange={handleInputChange}
                  className={`w-full p-2 border rounded ${isDarkMode ? 'bg-slate-600 border-slate-500' : 'bg-white border-gray-300'}`}
                  placeholder="Key strengths identified during appraisal"
                  rows="2"
                ></textarea>
              </div>
              <div className="mb-4">
                  ...
                  <div className="relative z-10 mt-6">
                    ...
                    <div className="mb-8 px-8 text-center">
                      ...
                      <p className="mb-6 text-lg font-serif leading-relaxed">
                        has successfully completed the post-appraisal process for the period <span className="font-bold">{formData.appraisalPeriod || "[Appraisal Period]"}</span> and has achieved a score of <span className="font-bold">{formData.appraisalScore || "[Score]"}</span>.
                      </p>
                      <div
                        style={{
                          background: '#f0f4fa',
                      ...
                      >
                        ...
                        <p style={{ fontStyle: 'italic', fontSize: '1.1rem', textAlign: 'center', margin: 0 }}>
                          {formData.strengths || "Key strengths demonstrated during the appraisal period."}
                        </p>
                      </div>
                      <div
                        style={{
                      ...
                      >
                        ...
                        <p style={{ fontStyle: 'italic', fontSize: '1.1rem', textAlign: 'center', margin: 0 }}>
                          {formData.improvementAreas || "Areas identified for further development and improvement."}
                        </p>
                      </div>
                      <p className="mb-2 text-lg font-serif">
                        We appreciate your efforts and dedication. Keep striving for excellence!
                      </p>
                    </div>
                    {/* Date and Signature */}
