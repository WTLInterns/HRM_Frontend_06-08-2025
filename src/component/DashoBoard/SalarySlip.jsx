  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://localhost:8081/api/employee/company/${encodeURIComponent(user.registercompanyname)}/employee/${selectedEmpId}/attendance/report?startDate=${apiStartDate}&endDate=${apiEndDate}`
      )
